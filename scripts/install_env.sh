...
#
# Requires: conda + an NVIDIA driver supporting CUDA 11.8. Validated on Python 3.10.
...
echo ">>> creating conda env '$ENV' (python 3.10)"
...
echo ">>> [2/5] numpy (<2; required by chumpy/opencv)"
...
run python -c "import torch, numpy, pyrealsense2, mujoco, cv2, chumpy, smplx, timm, ultralytics; \
